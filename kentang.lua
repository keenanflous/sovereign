...
local Window = WindUI:CreateWindow({
    ...
    Size = UDim2.fromOffset(500, 450), -- Diperbesar untuk fitur tambahan
    Theme = "Indigo",
    KeySystem = false
})
...
SectionSpeed:Toggle({
    ...
    Callback = function(value)
        ToggleSpeedHack(value, speedValue)
    end
})
...
SectionSpeed:Button({
    ...
    Callback = function()
        ...
        UpdateSpeed(16)
        if speedHackEnabled then
            ToggleSpeedHack(true, 16)
        end
        Notify("Speed", "Kecepatan direset ke normal", 2)
    end
})
