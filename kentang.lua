...
-- Section FPS Limit
local SectionFPS = PerfTab:Section({
    Title = "FPS LIMITER",
    Icon = "gauge"
})
...
-- Section FPS Monitor
local SectionMonitor = MonitorTab:Section({
    Title = "PERFORMANCE MONITOR",
    Icon = "activity"
})

SectionMonitor:Toggle({
    Title = "FPS Monitor",
...
SectionUIInfo:Button({
    ...
    Callback = function()
        ...
        task.wait(1)
        Window:Destroy()
        Notify("UI Reload", "UI berhasil di-reload!", 2)
    end
})
